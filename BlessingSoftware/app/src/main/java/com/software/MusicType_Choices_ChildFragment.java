...
public class MusicType_Choices_ChildFragment extends Fragment {
    ...
    public View choices;
    public int mark = -1;
    private String[] buttonTitle ={"古琴","古筝","二胡","琵琶","箜篌","柳琴","扬琴","竖箜篌","阮", "凤首箜篌","双排弦箜篌","雁柱箜篌","转调箜篌","卡龙琴","弓琴","达比亚","傣玎","托甫秀尔","东布尔","菲特克呐","三线琴","曲胡","中胡","老胡","高胡","京胡","板胡","马头琴",
    "唢呐","笛子","埙","箫","笙","葫芦丝","芦笙","小号","牛角","海螺","夜箫","侗笛","塞箫","瓦格洛","雄林","塔吉克竖笛","嘟噜","低音嘟噜","太平箫","嘎嗦","五月箫","筚箫","筚笋","勒绒","姊妹箫","双管侗笛","波晓呼","决篥杰",
    "编钟","锣","镲","木鱼","木琴","竹杠","钹","铙","铜铃","彝族中三弦","八宝铜铃","师刀","竹簧","蹈到","铁簧","锡伯族铁簧","大铙","钗","司涅","布哉","乳钹" ,"头钹","二钹","小钹","铝板琴","棒棒军","铜镜","竹梆",
    "大鼓","排鼓","腰鼓","战鼓","扁鼓","长鼓","手鼓","小鼓","太平鼓","环鼓","抬鼓","朗达玛","纳格拉","达玛如","建鼓","神鼓","那额","塔布尔","竹鼓","夏尔巴鼓","那额","塔布尔","竹鼓","夏尔巴鼓","八角鼓","铃鼓","达卜","黄泥鼓"};
    ...
    private void initMusicChoice() {
        for (int i =0;i<28;i++){
            MusicButtons musicView = new MusicButtons(buttonTitle[i+(mark-1)*28],1);
